# Mission: Informatics - Final Backend Plan v1.1
...
This version fixes the four design issues found during review.
...
- Initial rank is the rank with the lowest `minXP`, expected to be `rank_01`.
...
- `display_name` may be set from metadata or email prefix.
...
- The first/default rank must be `rank_01` unless there is already a better stable ID.
